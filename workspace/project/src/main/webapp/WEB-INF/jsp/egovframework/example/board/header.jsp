...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="/project/">Start Bootstrap</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <form:form modelAttribute="searchVO" id="searchForm" name="searchForm" method="post" cssClass="d-flex">
                    ...
                    <form:input cssClass="form-control me-2" path="searchKeyword" id="searchContent" type="text"  aria-label="Enter search term..." aria-describedby="button-search"></form:input>
